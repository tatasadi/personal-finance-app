  ...
  return (
    <div className="p-4 md:p-8">
      <div className="max-w-[1140px] space-y-6 md:space-y-8">
        <h1 className="text-[32px] font-bold text-[#201F24]">Transactions</h1>
        ...
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex gap-3 w-full md:max-w-[320px]">
            <div className="relative flex-1">
              <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#696868]" />
              <Input
                type="text"
                ...
                className="pl-10 border-[#98908B] focus-visible:ring-[#201F24]"
              />
            </div>
              ...
              <Sheet open={sortSheetOpen} onOpenChange={setSortSheetOpen}>
                <SheetTrigger asChild>
                  <Button
                    variant="outline"
                    size="icon"
                    className="h-11 w-11 border-[#98908B]"
                  >
                    <SlidersHorizontal className="h-5 w-5 text-[#201F24]" />
                  </Button>
                </SheetTrigger>
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-3 rounded-lg text-sm font-bold ${
                          sortBy === option
                            ...
                            : "text-[#696868] hover:bg-[#F8F4F0]/50"
                        }`}
                      >
                        {getSortLabel(option)}
                      </button>
              ...
              <Sheet open={filterSheetOpen} onOpenChange={setFilterSheetOpen}>
                <SheetTrigger asChild>
                  <Button
                    ...
                    className="h-11 w-11 border-[#98908B]"
                  >
                    <Filter className="h-5 w-5 text-[#201F24]" />
                  </Button>
                </SheetTrigger>
                <SheetContent side="bottom" className="rounded-t-xl">
                  <SheetHeader>
          ...
          <div className="hidden md:flex gap-4">
            <div className="flex items-center gap-2">
              <span className="text-sm text-[#696868]">Sort by</span>
              <Select
                value={sortBy}
                onValueChange={(value) => {
              ...
              >
                <SelectTrigger className="w-[130px] border-[#98908B]">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
        ...
        <div className="hidden md:block">
          <Table>
            <TableHeader>
              <TableRow className="border-b border-[#F8F4F0] hover:bg-transparent">
                <TableHead className="text-xs text-[#696868] font-normal">
                  Recipient / Sender
                </TableHead>
                <TableHead className="text-xs text-[#696868] font-normal">
                  Category
                ...
                <TableHead className="text-xs text-[#696868] font-normal text-right">
                  Amount
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {paginatedTransactions.map((transaction) => (
                <TableRow
                  key={transaction.id}
                  className="border-b border-[#F8F4F0] hover:bg-[#F8F4F0]/50"
                >
                  ...
                  <TableCell className="text-xs text-[#696868]">
        ...
        <div className="md:hidden space-y-3">
          {paginatedTransactions.map((transaction) => (
            <div
              key={transaction.id}
              className="flex items-center justify-between py-4 border-b border-[#F8F4F0] last:border-0"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#696868] mt-1">
                    {transaction.category}
                  </p>
                </div>
              </div>
        ...
        {totalPages > 1 && (
          <div className="mt-6 flex items-center justify-between">
            <button
              ...
              className="flex items-center gap-2 rounded-lg border border-[#98908B] px-3 md:px-4 py-2 text-sm font-bold text-[#201F24] hover:bg-[#F8F4F0] disabled:opacity-50 disabled:cursor-not-allowed"
            >
                ...
                <button
                  ...
                  className={`h-10 min-w-[40px] rounded-lg text-sm font-bold ${
                    page === currentPage
                      ...
                      : "border border-[#98908B] text-[#201F24] hover:bg-[#F8F4F0]"
